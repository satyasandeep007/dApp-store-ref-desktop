		...
		<div className={`pr-4  `}>
			...
			>
				...
				>
					<div className="grow">
						<Link
							href={`/categories/?categories=${category.category}`}
						>
					...
					{hasSubCategories && (
						<div
							className={`self-center   ${
								isExpanded ? "rotate-180 pl-[8px]" : " pr-[8px]"
							}`}
						>
							<svg
								className="self-center"
			...
			{open &&
				...
				category.subCategory.map((e) => (
					...
					>
						...
						>
							<p
								className={`text-[16px] font-[500] py-[10px] hover:text-[#fff] capitalize ${
									query?.subCategory === e
										? " text-white "
										: "text-[#87868C]"
								}`}
				...
				>
					<Row className="min-h-[80vh] h-[80vh] pt-[20vh] pb-[10vh] max-md:pt-[40px] justify-center flex-col-reverse md:flex-row md:justify-start items-center text-center md:text-left container z-10">
						<div className="flex-initial w-full md:w-1/2">
							...
							<p className="w-full md:w-[70%] text-[16px] text-[#67666E] leading-[24px] font-[500] mb-[24px]">
								{subtitle}
							</p>
							<Button>
								<a
				...
				<aside className="hidden lg:flex md:flex-initial w-3/12 border-r border-r-border-color">
					<div className="w-full">
						<div className="border-b border-b-border-color">
							<div
								className={` align-middle items-center pt-2 pb-2 mr-4 my-2 ${
							...
							>
								<Link href="/history">
									<svg
										className="inline-block mr-2 pb-[5px]"
										width="24"
										height="25"
										viewBox="0 0 24 25"
										fill="none"
